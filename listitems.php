...
<head>
    ...
    <title>List Items | Cake Hub</title>
            ...
            <div class="wrap-contact100">
                <div class="contact100-form validate-form">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Name is required">
                        <img src="styles/add-product_7245827.png" style="margin-right: 50px;" alt="" width="90px" id="i0">
                        <img src="styles/add-product_7245827.png" style="margin-right: 50px;" alt="" width="90px" id="i1">
                        <img src="styles/add-product_7245827.png" alt="" width="90px" id="i2">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Name is required">
                        ...
                        <input class="input100" type="text" name="product title" placeholder="Enter your Short Product Title" id="title">
                        <span class="focus-input100"></span>
                    </div>
                    <div class="wrap-input100 validate-input" data-validate="Message is required">
                        <span class="label-input100">Short Desciption</span>
                        <textarea class="input100" name="message" id="srd" placeholder="Enter Your Product Short Description.&nbsp; &nbsp; &nbsp; This is reqiured For Home Section"></textarea>
                        <span class="focus-input100"></span>
                    </div>
                    <div class="wrap-input100 validate-input" data-validate="Message is required">
                        <span class="label-input100">Long Desciption</span>
                        <textarea class="input100" name="message" id="ld" placeholder="Enter Your Product Long Description.&nbsp; &nbsp; &nbsp; &nbsp; This is reqiured For Single Product &nbsp; &nbsp; &nbsp; &nbsp;View Section"></textarea>
                        <span class="focus-input100"></span>
                    </div>
                    <div class="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                        <span class="label-input100">Cost Per Item</span>
                        <input class="input100" type="text" name="email" id="cost" placeholder="Enter your product's Single cost">
                        <span class="focus-input100"></span>
                    </div>
                    <div class="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                        <span class="label-input100">Delivery Cost</span> </br>
                        <span class="label-input100"><b>Delivery Cost In Colombo</b></span>
                        <input class="input100" type="text" name="email" id="dtc" placeholder="Enter your product's delivery cost">
                        <span class="focus-input100"></span>
                        <span class="label-input100"><b>Delivery Cost outside Colombo</b></span>
                        <input class="input100" type="text" name="email" id="dto" placeholder="Enter your product's delivery cost">
                        <span class="focus-input100"></span>
                    </div>
                    <div class="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                        <span class="label-input100">Product Quantity</span>
                        <input class="input100" type="number" name="email" id="pq" placeholder="Enter your product quantity">
                        <span class="focus-input100"></span>
                    </div>
                    <div class="wrap-input100 input100-select">
                        <span class="label-input100">Product Category</span>
                        <div class="custom-dropdown">
                            <select class="selection-2" id="category" name="service">
                    ...
                    <div class="container-contact100-form-btn">
                        <div class="wrap-contact100-form-btn">
                            <div class="contact100-form-bgbtn"></div>
                            <button class="contact100-form-btn" onclick="addProduct();">
                                <span>
                                    List Product
